...
export default function Contact() {
  return (
    <section
      id="contact"
      className="py-12 md:py-20 px-4 sm:px-6 max-w-7xl mx-auto overflow-hidden"
    >
      <motion.h2
      ...
      >
        <div className="hidden sm:block h-px w-8 md:w-24 bg-linear-to-r from-transparent to-slate-700"></div>
        Get In Touch
        <div className="hidden sm:block h-px w-8 md:w-24 bg-linear-to-l from-transparent to-slate-700"></div>
      </motion.h2>
      ...
      <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center bg-slate-900/40 border border-slate-800 p-6 sm:p-8 md:p-12 rounded-[30px] md:rounded-[40px] backdrop-blur-xl shadow-2xl relative overflow-hidden">
        ...
        >
          ...
          <div className="relative w-full aspect-square sm:aspect-video lg:aspect-square overflow-hidden rounded-3xl border border-slate-700 bg-slate-800">
            <img
