...
export default function Tools() {
  ...
  const techStack = [
    ...
    { name: "MAMP", icon: "./src/assets/mamplogo.webp" },
    {
      name: "Laravel",
    ...
    {
      name: "HeidiSQL",
      icon: "./src/assets/menu_image.png",
    },
  ];
  ...
  const projects = [
    {
      ...
      link: "#",
      image: "./src/assets/Screenshot 2025-12-27 170833.png", // Ganti ke path lokal: "./src/assets/project1.png"
    },
    {
      title: "Online Tutoring Website",
      desc: "Manajemen stok barang gudang realtime menggunakan Laravel & MySQL untuk optimasi bisnis.",
      link: "#",
      image: "src/assets/Screenshot 2025-12-27 165846.png", // Ganti ke path lokal: "./src/assets/project2.png"
    },

    {
      ...
      desc: "Manajemen stok barang gudang realtime menggunakan Laravel & MySQL untuk optimasi bisnis.",
      link: "#",
      image: "src/assets/Screenshot 2025-12-27 172529.png", // Ganti ke path lokal: "./src/assets/project2.png"
    },

    {
      ...
      desc: "Manajemen stok barang gudang realtime menggunakan Laravel & MySQL untuk optimasi bisnis.",
      link: "#",
      image: "src/assets/Screenshot 2025-12-27 165812.png", // Ganti ke path lokal: "./src/assets/project2.png"
    },
  ];
